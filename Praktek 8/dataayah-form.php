...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["thnlhrayah"])) {
            $error_tlayah = "Tanggal Lahir Tidak Boleh Kosong";
        } else {
            $tlayah = cek_input($_POST["thnlhrayah"]);
            if (!is_numeric($thnlhrayah)) {
                $error_thnlhrayah= "Tanggal Lahir Hanya Boleh Angka";
            }
        }
...
<div class="row">
        <div class="col-md-10 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="dataayah-proses.php">
                    ...
                    <div class="form-group row">
                        <label for="thnlhrayah" class="col-sm-2 col-form-label">Tahun Lahir</label>
                        <div class="col-sm-10">
                            <input type="text" name="thnlhrayah" id="thnlhrayah" class="form-control <?php echo ($error_thnlhrayah !="" ? "is-invalid" : ""); ?>" placeholder="" value="<?php echo $thnlhrayah; ?>"> <span class="warning"><?php echo $error_thnlhrayah ?></span>
                        </div>
                    </div><br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="radio" name="gajiayah" value="< 500.000"> < 500.000 </label> <br>
                            <input type="radio" name="gajiayah" value="500.000 - 999.9999"> 500.000 - 999.9999 </label><br>
                            <input type="radio" name="gajiayah" value="1.000.000 - 1.999.999"> 1.000.000 - 1.999.999 </label><br>
                            <input type="radio" name="gajiayah" value="2.000.000 - 4.999.999"> 2.000.000 - 4.999.999 </label><br>
                            <input type="radio" name="gajiayah" value="5.0000.000 - 20.000.000"> 5.0000.000 - 20.000.000 </label> <br>
                    ...
                    <div class="form-group row">
                        <label for="berkebkhususayah" class="col-sm-2 col-form-label "> Berkebutuhan Khusus </label>
                        <div class="col-sm-10">
                            <select class="col-sm-2 form-select" name="berkebkhususayah">
                            <option value=""></option>
                            ...
                            <span class="warning" ><?php echo $error_berkebkhususayah; ?></span>
                        </div>
                    </div>
