...
<div class="row">
        <div class="col-md-10 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="datapribadi-proses.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="radio" name="jnskelamin" value="Laki Laki">Laki-Laki</label>
                            <input type="radio" name="jnskelamin" value="Perempuan">Perempuan</label> 
                            <span class="warning" ><?php echo $error_jnskelamin; ?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="tmplahir" id="tmplahir" class="form-control" <?php echo ($error_tmplahir !="" ? "is-invalid" : ""); ?>" placeholder="" value="<?php echo $tmplahir; ?>"> <span class="warning"><?php echo $error_tmplahir ?></span>
                        </div>
                    </div> <br>
                    ...
                    <div class="form-group row">
                        <label for="alamatjln" class="col-sm-2 col-form-label">Alamat Jalan</label>
                        <div class="col-sm-10">
                            <input type="text" name="alamatjln" id="alamatjln" class="form-control" <?php echo ($error_alamatjln !="" ? "is-invalid" : ""); ?>" placeholder="" value="<?php echo $alamatjln; ?>"> <span class="warning"><?php echo $error_alamatjln ?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="col-sm-2 form-select" name="tmptinggal">
                            <option value=""></option>
                    ...
                    <div class="form-group row">
                        <label for="kpspkhkip" class="col-sm-2 col-form-label">Penerima KPS/PKH/KIP</label>
                        <div class="col-sm-10">
                            <input type="radio" name="kpspkhkip" value="Ya">Ya</label>
                            <input type="radio" name="kpspkhkip" value="Tidak">Tidak</label> 
                            <span class="warning" ><?php echo $error_kpspkhkip; ?></span>
                        </div>
                    </div> <br>

                    <div class="form-group row">
                        <label for="nokpskkspkhkip" class="col-sm-2 col-form-label">Nomor KPS/KKS/PKH/KIP</label>
                        <div class="col-sm-10">
                            <input type="text" name="nokpskkspkhkip" id="nokpskkspkhkip" class="form-control" <?php echo ($error_nokpskkspkhkip !="" ? "is-invalid" : ""); ?>" placeholder="XX" value="<?php echo $nokpskkspkhkip; ?>"> <span class="warning"><?php echo $error_nokpskkspkhkip ?></span>
                        </div>
                    </div> <br>
